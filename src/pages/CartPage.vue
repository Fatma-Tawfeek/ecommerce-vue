                                ...
                                >
                                    ...
                                    >
                                        <RouterLink
                                            ...
                                            >{{ product.product.title }}</RouterLink
                                        >
                            ...
                            <div class="space-y-2">
                                <dl class="flex items-center justify-between gap-4">
                                    ...
                                    <dd class="text-base font-medium text-gray-900 dark:text-white">
                                        ${{ cartStore.cartItems.totalCartPrice }}
                                    </dd>
                                </dl>
                            </div>
...
function removeCartItem(id) {
    axios
        ...
        .then((res) => {
            ...
            cartStore.cartItems = res.data.data;
            toast("Item removed", {
                theme: "colored",
                type: "success",
                autoClose: 2000,
